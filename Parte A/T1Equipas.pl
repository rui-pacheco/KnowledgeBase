...
inicio:- write("Bem vindo ao organizador de equipas. Por favor responta às seguintes questões para configurar as equipas."), nl,nl,nl,write("Equipas predefinidas :"),initial(S0),write(S0),nl,nl,nl,write("1. Hill Climbing Standard"),nl,write("2. Hill Climbing Estocastico"),nl,write("3.Configuracoes"),nl, read(X),(
