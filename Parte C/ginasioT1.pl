...
nl,nl,
    ...
    write('Esforço Muscular: '), write(EM), nl,nl,
...
inicio:- write('Bem vindo ao assistente à escolha de atividade fisica'),nl, write('Responda às seguintes perguntas para saber a sua atividade fisica ideal'),nl,nl,write('1. Iniciar Teste'),nl,write('2.Sair do assistente'),nl,nl, read(X),verificar(X).
verificar(1):- pergunta1.
verificar(2):- halt.

pergunta1:-write('Qual a faixa etária em que se insere?'),nl,nl,write('1. 5 aos 8 anos'),nl, write('2. 8 aos 12 anos'),nl,write('3. 12 aos 16 anos'),nl,write('4. +16 anos'),nl, read(Resposta1),(
...
pergunta2:-write('Qual a razão para a prática da atividade fisica?'),nl,nl,write('1. Competicao'),nl, write('2. Fisioterapia'),nl,write('3. Hipertrofia'),nl,write('4. Perda de Peso'),nl,write('5. Manutencao da condicao fisica'),nl, read(Resposta2),(
...
pergunta4:-write('Gosta de dançar?'),nl,nl,write('1. Sim'),nl, write('2. Nao'),nl, read(Resposta4),(
    (Resposta4==1), assert(fact(danca)), nl, pergunta5;
    (Resposta4==2), assert(fact(naodanca)), nl, pergunta5).

pergunta5:-write('Qual é a sua disponibilidade?'),nl,nl,write('1. 09:00 - 13:00'),nl, write('2. 13:00 - 17:00'),nl,write('3. 17:00 - 22:00'),nl, read(Resposta5),(
